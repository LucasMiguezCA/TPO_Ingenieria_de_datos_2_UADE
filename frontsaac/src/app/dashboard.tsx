...
const s = StyleSheet.create({
  ...
  avatarLetra: { color: '#050a0e', fontSize: 20, fontWeight: '800' },
  holaText: { fontSize: 12, color: 'rgba(240,244,248,0.6)', fontWeight: '500' },
  nombreText: { fontSize: 18, fontWeight: '800', color: '#f0f4f8', letterSpacing: 0.5 },
  logoutBtn: { width: 44, height: 44, borderRadius: 14, backgroundColor: '#E5E7EB', justifyContent: 'center', alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 2 },
  logoutIcon: { fontSize: 20, color: '#374151', fontWeight: '800' },
  topContainerSmall: { flexDirection: 'column', alignItems: 'stretch', gap: 10 },
  phraseBar: { flex: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 16, paddingHorizontal: 14, paddingVertical: 10, gap: 8, minHeight: 48, borderWidth: 1.2, borderColor:'rgba(255,255,255,0.15)', shadowColor: 'rgba(79,195,247,0.1)', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 4, elevation: 1 },
  phraseScroll: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  phrasePlaceholder: { color: 'rgba(240,244,248,0.65)', fontSize: 14, fontWeight: '500' },
